...
hi def link cConditional	Question
hi def link cRepeat		Question
...
" Math Operator
hi cMathOperator ctermfg=6 cterm=bold ctermfg=4
hi cPointerOperator ctermfg=6 cterm=bold ctermfg=4
hi cLogicalOperator ctermfg=6 cterm=bold ctermfg=4
hi cBinaryOperator ctermfg=6 cterm=bold ctermfg=4
hi cBinaryOperatorError ctermfg=6 cterm=bold ctermfg=4
hi cLogicalOperator ctermfg=6 cterm=bold ctermfg=4
hi cLogicalOperatorError ctermfg=6 cterm=bold ctermfg=4
